...
class Services: NSObject {
    ...
    func performSearchWithMap(searchLocation: CLLocation, searchString: String, mapView: MKMapView, completion: @escaping (MKMapView, [MKMapItem]) ->()) {
    ...
    func performSearch(searchLocation: CLLocation, searchString: String, completion: @escaping ([MKMapItem]) ->()) {
